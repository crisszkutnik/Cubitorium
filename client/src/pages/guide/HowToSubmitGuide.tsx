        ...
        <div className="relative h-screen">
            <div className="relative flex flex-col items-center space-y-12 mt-10">
                <div className="container mx-auto p-4 text-center items-center">
                    ...
                    <div className="mt-10 mb-10">
                        <h2 className="text-2xl mb-3">Step 1: Select your case</h2>
                            <div className="mb-4 flex items-center justify-center">
                                ...
                                <img src="/public/step-01.jpeg" className="border-1 border-purple-800 mb-2 inline-block h-2/5 w-2/4" />
                            </div>
                            <hr/>
                    </div>
                    ...
                    {/* Step 2 */}
                    <div className="mt-10 mb-10">
                    <h2 className="text-2xl mb-3">Step 2: Add a solution for the selected case</h2>
                    <div className="mb-4 flex items-center justify-center">
                    <img src="/public/step-02.jpeg" className="border-1 border-purple-800 mb-2 inline-block h-3/5 w-4/4" />
                    ...
                    <div className="mb-4 flex items-center justify-center">
                        ...
                        <img src="/public/step-03.jpeg" className="border-1 border-purple-800 mb-2 inline-block h-80 w-500" />
                    </div>
                    <hr/>
                    </div>
                    ...
                    <div className="mb-4 flex items-center justify-center">
                        ...
                        <img src="/public/step-04.jpeg" className="border-1 border-purple-800 mb-2 inline-block h-80 w-500" />
                        <p className="text-md text-gray-600 mb-4 ml-6 max-w-xs text-left">
                        Start cubing!<br/>
                    ...
                    <div className="mb-4 flex items-center justify-center">
                        ...
                        <img src="/public/step-05.jpeg" className="border-1 border-purple-800 mb-2 inline-block h-80 w-500" />
                    </div>
                    <hr/>
                    </div>
